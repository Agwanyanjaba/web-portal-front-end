...
@Component({
  selector: 'app-inactive-merchants',
  templateUrl: './inactive-merchants.component.html',
  styleUrls: ['./inactive-merchants.component.css']
})
export class InactiveMerchantsComponent implements OnInit {
  ...
  pageChanged(currentPage) {
    ...
    this.merchantservice.getInactiveMerchants(page)
      .subscribe(merchants => {
