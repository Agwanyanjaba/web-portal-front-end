...
@Component({
  selector: 'app-checker-pending-instructions',
  templateUrl: './checker-pending-instructions.component.html',
  styleUrls: ['./checker-pending-instructions.component.css']
})
export class CheckerPendingInstructionsComponent implements OnInit {
  ...
  pageChanged(currentPage) {
    ...
    this.settlementService.getCheckerPendingSettlementInstructionList(page)
  ...
  approveSettlement() {
    ...
    this.spinnerService.show();
    this.settlementService.checkerApproveDetails(localStorage.getItem('payrefno'))
      .subscribe(settlementinstructions => {
        this.settlementInstructions = settlementinstructions;
